...
DEVICE_SUPPORT_PATH := $(C2000WARE_PATH)/device_support/f28p55x
DRIVERLIB_PATH := $(C2000WARE_PATH)/driverlib/f28p55x/driverlib
...
ifeq ($(CC),$(TI_CCS_PATH)/bin/cl2000)
    # TI編譯器選項
    CFLAGS := -v28 -ml -mt --tmu_support=tmu1 \
              --abi=eabi \
              --cla_support=cla2 \
              --float_support=fpu32 \
              --tmu_support=tmu0 \
